...
INSERT INTO member (`name1`, `name2`, `phonetic1`, `phonetic2`, `sex`, `admission`, `degree`, `depart`, `expert`, `graduate`, `position`)
  VALUES
  ('陸上', '悠真', 'りくじょう', 'ゆうま', '男子', 2016, '学士', '法学部', '短距離', '東京（東京）', '主将'),
  ('陸上', '結菜', 'りくじょう', 'ゆうな', '女子', 2016, '学士', '経済学部', '短距離', '東京（東京）', '渉外'),
  ('東京', '悠人', 'とうきょう', 'ゆうと', '男子', 2016, '学士', '理学部', '短距離', '東京（東京）', '副将'),
  ('東京', '咲良', 'とうきょう', 'さくら', '女子', 2016, '学士', '教育学部', '短距離', '東京（東京）', '副将'),
  ('幹部', '蓮', 'かんぶ', 'れん', '男子', 2017, '学士', '工学部', '長距離', '横浜（神奈川）', NULL),
  ('幹部', '結衣', 'かんぶ', 'ゆい', '女子', 2017, '学士', '経済学部', '長距離', '横浜（神奈川）', NULL),
  ('星野', '陽翔', 'ほしの', 'はると', '男子', 2014, '学士', '工学部', '投擲', '埼玉（埼玉）', NULL),
