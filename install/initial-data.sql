...
INSERT INTO competition (`competition`, `place`, `start`)
  VALUES
  ('第1回陸上長距離競技会', '駒沢オリンピック公園総合運動場陸上競技場', '2018-04-14'),
  ('第1回体育大学競技会', '江東区夢の島競技場', '2018-04-14'),
  ('第1回体育大学長距離競技会', '江東区夢の島競技場', '2018-04-14'),
  ('第1回体育大学競技会', 'ヤンマーフィールド長居', '2017-04-02'),
  ('第1回体育大学長距離競技会', 'ヤンマーフィールド長居', '2017-04-02'),
  ('第1回陸連記録会', 'ヤンマーフィールド長居', '2018-03-11');
