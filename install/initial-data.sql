...
INSERT INTO member (`name1`, `name2`, `phonetic1`, `phonetic2`, `sex`, `grade`, `year`, `degree`, `depart`, `expert`, `graduate`, `position`)
  VALUES
  ('陸上', '悠真', 'りくじょう', 'ゆうま', '男子', 7, 3, '学位', '法学部', '短距離', '東京（東京）', '主将'),
  ('陸上', '結菜', 'りくじょう', 'ゆうな', '女子', 7, 3, '学位', '経済学部', '短距離', '東京（東京）', '渉外'),
  ('東京', '悠人', 'とうきょう', 'ゆうと', '男子', 7, 3, '学位', '理学部', '短距離', '東京（東京）', '副将'),
  ('東京', '咲良', 'とうきょう', 'さくら', '女子', 7, 3, '学位', '教育学部', '短距離', '東京（東京）', '副将'),
  ('幹部', '蓮', 'かんぶ', 'れん', '男子', 8, 2, '学位', '工学部', '長距離', '横浜（神奈川）', NULL),
  ('幹部', '結衣', 'かんぶ', 'ゆい', '女子', 8, 2, '学位', '経済学部', '長距離', '横浜（神奈川）', NULL),
  ('星野', '陽翔', 'ほしの', 'はると', '男子', 5, 5, '学位', '工学部', '投擲', '埼玉（埼玉）', NULL),
  ('水卜', '莉子', 'みうら', 'りこ', '女子', 5, 1, '修士', '教育学研究科', '跳躍', '埼玉（埼玉）', NULL),
  ('水卜', '心愛', 'みうら', 'ここあ', '女子', 3, 1, '博士', '法学系研究科', '跳躍', '埼玉（埼玉）', NULL);
