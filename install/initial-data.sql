...
INSERT INTO event (`event`, `sex`, `record`, `order`, `relay_flag`, `combined_flag`)
  ...
  ('駅伝', '男子', false, 73, true, false),
  ('駅伝', '女子', false, 74, true, false);
...
INSERT INTO member (`name1`, `name2`, `phonetic1`, `phonetic2`, `sex`, `admission`, `degree`, `depart`, `expert`, `graduate`, `position`)
  VALUES
  ('陸上', '悠真', 'りくじょう', 'ゆうま', '男子', 2016, '学位', '法学部', '短距離', '東京（東京）', '主将'),
  ('陸上', '悠真', 'りくじょう', 'ゆうま', '男子', 2016, '学位', '法学部', '短距離', '東京（東京）', '主将'),
  ('陸上', '結菜', 'りくじょう', 'ゆうな', '女子', 2016, '学位', '経済学部', '短距離', '東京（東京）', '渉外'),
  ('東京', '悠人', 'とうきょう', 'ゆうと', '男子', 2016, '学位', '理学部', '短距離', '東京（東京）', '副将'),
  ('東京', '咲良', 'とうきょう', 'さくら', '女子', 2016, '学位', '教育学部', '短距離', '東京（東京）', '副将'),
  ('幹部', '蓮', 'かんぶ', 'れん', '男子', 2017, '学位', '工学部', '長距離', '横浜（神奈川）', NULL),
  ('幹部', '結衣', 'かんぶ', 'ゆい', '女子', 2017, '学位', '経済学部', '長距離', '横浜（神奈川）', NULL),
  ('星野', '陽翔', 'ほしの', 'はると', '男子', 2014, '学位', '工学部', '投擲', '埼玉（埼玉）', NULL),
  ('水卜', '莉子', 'みうら', 'りこ', '女子', 2018, '修士', '教育学研究科', '跳躍', '埼玉（埼玉）', NULL),
  ('水卜', '心愛', 'みうら', 'ここあ', '女子', 2018, '博士', '法学系研究科', '跳躍', '埼玉（埼玉）', NULL);

INSERT INTO result (`result`, `competition`, `event`, `round`, `member`, `record`)
  VALUES
  ('11\"11(+1.0)', 2, 1, NULL, 1, 1111),
  ('12\"03(+1.0)', 2, 2, NULL, 2, 1203),
  ('11\"37(+1.0)', 2, 1, NULL, 3, 1137),
  ('12\"21(+1.0)', 2, 2, NULL, 4, 1221),
  ('11\"21(+0.3)', 6, 1, 1, 1, 1121),
  ('10\"87(+1.5)', 6, 1, 3, 1, 1087);
